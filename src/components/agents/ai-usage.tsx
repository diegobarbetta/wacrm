      ...
      <CardHeader>
        <div className="flex items-start justify-between gap-4">
          <div>
            ...
            <CardDescription>
              Tokens consumidos da chave do provedor por rascunhos e respostas
              automáticas. Somente as quantidades são armazenadas.
            </CardDescription>
          </div>
          <Select
            value={String(days)}
      ...
      <CardContent className="space-y-5">
        {loading || !data ? (
          ...
          <div className="text-muted-foreground flex flex-col items-center justify-center gap-2 py-10 text-center text-sm">
            ...
            <p className="text-xs">
              Os dados aparecerão conforme o assistente criar rascunhos e
              respostas.
            </p>
          </div>
        ) : (
          <>
            ...
            {data.truncated && (
              <p className="text-muted-foreground text-xs">
                Exibindo uma janela parcial — apenas os registros mais recentes
                estão resumidos aqui devido ao volume de uso.
              </p>
            )}
          </>
        )}
